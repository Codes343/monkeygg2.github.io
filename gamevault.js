...
const GAMES = [
  ...
  // ── EVEN MORE GAMES ──────────────────────────────────
  {id:'run-1',             name:'Run',                    cat:'retro',      emoji:'👟', hot:false, path:'https://sites.google.com/site/unblockedwtf/run',                  tip:'← → steer · Space jump · the original!', ext:true},
  {id:'run-2',             name:'Run 2',                  cat:'retro',      emoji:'👟', hot:false, path:'https://sites.google.com/site/unblockedwtf/run-2',                tip:'← → steer · Space jump · harder tunnels', ext:true},
  {id:'bad-time-sim',      name:'Bad Time Simulator',     cat:'action',     emoji:'💀', hot:true,  isNew:true, path:'https://sites.google.com/site/unblockedwtf/bad-time-simulator',   tip:'Sans boss fight from Undertale · good luck', ext:true},
  {id:'bullet-force',      name:'Bullet Force',           cat:'action',     emoji:'🔫', hot:true,  isNew:true, path:'https://sites.google.com/site/unblockedwtf/bullet-force',          tip:'FPS shooter · WASD move · mouse aim', ext:true},
  {id:'ragdoll-soccer',    name:'Ragdoll Soccer',         cat:'sports',     emoji:'⚽', hot:false, path:'https://sites.google.com/site/unblockedwtf/ragdoll-soccer',        tip:'Wacky ragdoll physics soccer', ext:true},
  {id:'stickman-parkour',  name:'Stickman Parkour',       cat:'platformer', emoji:'🏃', hot:false, path:'https://sites.google.com/site/unblockedwtf/stickman-parkour',      tip:'← → run · Space/W jump · avoid obstacles', ext:true},
  {id:'stickman-parkour2', name:'Stickman Parkour 2',     cat:'platformer', emoji:'🏃', hot:false, path:'https://sites.google.com/site/unblockedwtf/stickman-parkour-2',    tip:'More levels · harder parkour', ext:true},
  {id:'fancy-pants',       name:'Fancy Pants Adventures', cat:'platformer', emoji:'✏️', hot:false, path:'https://sites.google.com/site/unblockedwtf/fancy-pants-adventures', tip:'← → run · S duck · W/↑ jump · stylish!', ext:true},
  {id:'fancy-pants-2',     name:'Fancy Pants 2',          cat:'platformer', emoji:'✏️', hot:false, path:'https://sites.google.com/site/unblockedwtf/fancy-pants-adventure-2',tip:'More adventure · more swag', ext:true},
  {id:'cat-ninja',         name:'Cat Ninja',              cat:'platformer', emoji:'🐱', hot:false, path:'https://sites.google.com/site/unblockedwtf/cat-ninja',             tip:'Arrow keys · ninja through levels', ext:true},
  {id:'gun-mayhem-2',      name:'Gun Mayhem 2',           cat:'action',     emoji:'🔫', hot:false, path:'https://sites.google.com/site/unblockedwtf/gun-mayhem-2',          tip:'WASD move · F shoot · throw grenades', ext:true},
  {id:'superfighters',     name:'SuperFighters Ultimate', cat:'action',     emoji:'💥', hot:false, path:'https://sites.google.com/site/unblockedwtf/superfighters-ultimate', tip:'WASD move · E pick up · shoot and punch', ext:true},
  {id:'rogue-soul-2',      name:'Rogue Soul 2',           cat:'platformer', emoji:'⚔️', hot:false, path:'https://sites.google.com/site/unblockedwtf/rogue-soul-2',          tip:'← → run · Space jump · slash enemies', ext:true},
  {id:'bob-robber',        name:'Bob The Robber',         cat:'adventure',  emoji:'🕵️', hot:false, path:'https://sites.google.com/site/unblockedwtf/bob-the-robber',        tip:'WASD sneak · avoid guards · steal stuff', ext:true},
  {id:'bob-robber-2',      name:'Bob The Robber 2',       cat:'adventure',  emoji:'🕵️', hot:false, path:'https://sites.google.com/site/unblockedwtf/bob-the-robber-2',      tip:'More heists · harder levels', ext:true},
  {id:'dead-zed',          name:'Dead Zed',               cat:'action',     emoji:'🧟', hot:false, path:'https://sites.google.com/site/unblockedwtf/dead-zed',              tip:'Mouse aim · click shoot · defend your base', ext:true},
  {id:'earth-taken-3',     name:'Earth Taken 3',          cat:'action',     emoji:'🌍', hot:false, path:'https://sites.google.com/site/unblockedwtf/earth-taken-3',         tip:'Survive alien invasion · WASD move', ext:true},
  {id:'a-small-world-cup', name:'A Small World Cup',      cat:'sports',     emoji:'🏆', hot:true,  isNew:true, path:'https://sites.google.com/site/unblockedwtf/a-small-world-cup',   tip:'Flip and score goals · ragdoll soccer', ext:true},
  {id:'swords-souls',      name:'Swords and Souls',       cat:'strategy',   emoji:'⚔️', hot:false, path:'https://sites.google.com/site/unblockedwtf/swords-and-souls',      tip:'Train your fighter · battle in the arena', ext:true},
  {id:'dragon-ball-z',     name:'Dragon Ball Z Devolution',cat:'action',    emoji:'🐉', hot:false, path:'https://sites.google.com/site/unblockedwtf/dragon-ball-z-devolution',tip:'Pick your fighter · 1v1 or story mode', ext:true},
  {id:'one-piece-fight',   name:'One Piece Fighting',     cat:'action',     emoji:'☠️', hot:false, path:'https://sites.google.com/site/unblockedwtf/one-piece-fighting',     tip:'WASD move · attack · special moves', ext:true},
  {id:'bleach-naruto',     name:'Bleach vs Naruto',       cat:'action',     emoji:'⚔️', hot:true,  isNew:true, path:'https://sites.google.com/site/unblockedwtf/bleach-vs-naruto',    tip:'Pick your anime fighter · 1v1 battles', ext:true},
  {id:'minecraft-parkour', name:'Minecraft Parkour',      cat:'retro',      emoji:'⛏️', hot:false, path:'https://sites.google.com/site/unblockedwtf/minecraft-parkour',      tip:'WASD move · Space jump · parkour courses', ext:true},
  {id:'short-life',        name:'Short Life',             cat:'platformer', emoji:'😵', hot:false, path:'https://sites.google.com/site/unblockedwtf/short-life',             tip:'Navigate obstacles without dying · ragdoll', ext:true},
  {id:'short-life-2',      name:'Short Life 2',           cat:'platformer', emoji:'😵', hot:false, path:'https://sites.google.com/site/unblockedwtf/short-life-2',           tip:'More deadly obstacles · more ragdolling', ext:true},
  {id:'madalin-cars',      name:'Madalin Cars Multiplayer',cat:'racing',    emoji:'🚗', hot:false, path:'https://sites.google.com/site/unblockedwtf/madalin-cars-multiplayer',tip:'Drive fancy cars · stunt course · multiplayer', ext:true},
  {id:'earn-to-die',       name:'Earn to Die',            cat:'racing',     emoji:'🚗', hot:false, path:'https://sites.google.com/site/unblockedwtf/earn-to-die',            tip:'Drive through zombies · upgrade your car', ext:true},
  {id:'learn-to-fly',      name:'Learn to Fly 2',         cat:'fun',        emoji:'🐧', hot:false, path:'https://sites.google.com/site/unblockedwtf/learn-to-fly-2',         tip:'Launch penguin · upgrade · fly to the moon', ext:true},
  {id:'strike-force-2',    name:'Strike Force Heroes 2',  cat:'action',     emoji:'🔫', hot:false, path:'https://sites.google.com/site/unblockedwtf/strike-force-heroes-2',  tip:'WASD move · shoot · complete missions', ext:true},
  {id:'boxel-rebound',     name:'Boxel Rebound',          cat:'platformer', emoji:'📦', hot:false, path:'https://sites.google.com/site/unblockedwtf/boxel-rebound',          tip:'Tap to flip gravity · reach the goal', ext:true},
  {id:'slope-ball',        name:'Slope Ball',             cat:'racing',     emoji:'🔵', hot:false, path:'https://sites.google.com/site/unblockedwtf/slope-ball',             tip:'← → steer · alternate slope experience', ext:true},
  {id:'elasticman',        name:'Elastic Man',            cat:'fun',        emoji:'😮', hot:false, isNew:true, path:'https://sites.google.com/site/unblockedwtf/elastic-man',    tip:'Click and drag to stretch the face · oddly satisfying', ext:true},
  {id:'infinite-craft',    name:'Infinite Craft',         cat:'puzzle',     emoji:'⚗️', hot:true,  isNew:true, path:'https://sites.google.com/site/unblockedwtf/infinite-craft',  tip:'Combine elements · discover everything', ext:true},
  {id:'paper-minecraft',   name:'Paper Minecraft',        cat:'retro',      emoji:'📄', hot:false, path:'https://sites.google.com/site/unblockedwtf/paper-minecraft',         tip:'2D Minecraft · mine, craft, survive', ext:true},
  {id:'cubefield',         name:'Cubefield',              cat:'racing',     emoji:'🟦', hot:false, path:'https://sites.google.com/site/unblockedwtf/cubefield',              tip:'← → dodge the cubes · go as far as possible', ext:true},
  {id:'melon-playground',  name:'Melon Playground',       cat:'fun',        emoji:'🍈', hot:false, isNew:true, path:'https://sites.google.com/site/unblockedwtf/melon-playground', tip:'Sandbox physics · blow stuff up', ext:true},
  {id:'stumble-guys',      name:'Stumble Guys',           cat:'action',     emoji:'🏆', hot:true,  isNew:true, path:'https://sites.google.com/site/unblockedwtf/stumble-guys',    tip:'Race · dodge obstacles · be last standing', ext:true},
];
